...
bool QueryControl::resetDatabase() {
    ...
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (55,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (56,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (57,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (58,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (59,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (60,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (61,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (62,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (63,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (64,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (65,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (66,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (67,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (68,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (69,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (70,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (71,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (72,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (73,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (74,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (75,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (76,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (77,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (78,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (79,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (80,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (81,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (82,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (83,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (84,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (85,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (86,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (87,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (88,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (89,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (90,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (91,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (92,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (93,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (94,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO PurchasableItem (itemID,price,availability) "
                                        "VALUES (95,6.99,1);");                                                                                                                                                      //qDebug() << query.lastQuery() << query.lastError();
    ...
    noError = noError && query.exec("INSERT INTO Textbook (itemID,ISBN,coverImageLocation,desc,author,textbookTitle,publisher,edition) "
                                        "VALUES (55,'101-1-10-101010-0','./long.png','A Big Book wait what i want believe this is happening"
                                            ...
                                            "','Author of a Big Book',' a Big Book','a Big Book Inc.',' a Big Book edition');");                                                                // qDebug() << query.lastQuery() << query.lastError();
    noError = noError && query.exec("INSERT INTO Chapter (itemID,ISBN,chapterNumber,chapterTitle) "
